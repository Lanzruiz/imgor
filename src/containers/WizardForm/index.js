        ...
        const arrivalData = {
          attributes: {
            flight: {
              ...
              booked: false,
              date: stepSixArrivalDateTime ? moment(stepSixArrivalDateTime, 'YYYY-MM-DD hh:mm A').format('hh:mm A') : null,
        ...
        const departingData = {
          attributes: {
            flight: {
              ...
              booked: false,
              date: stepSixDepartingDateTime ? moment(stepSixDepartingDateTime, 'YYYY-MM-DD hh:mm A').format('hh:mm A') : null,
